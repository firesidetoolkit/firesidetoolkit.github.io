...
lists: one for Hubs, one for Path Groups, and one for Paths (more on each below). Above these lists,
...
field with individual lines of dialogue you would like to appear. Click the "Create Dialogue" 
button below the "Dialogue Text" field. The Dialogue will appear in the Dialogue list to the left of 
the "Dialogue Text" field. Dialogues will appear in the game in the order they appear on the 
...
down buttons. Select the desired direction on the list that you wish the dialogue to be moved in. The Dialogue 
list will update with the new order of dialogues. Click the "Save" button at the bottom right of any of 
the tabs on the "Edit Path" screen to save your changes.
...
right of any tab on the "Edit Path" screen to save your changes.
...
of the tabs on the "Edit Path" screen to save your changes.
...
dialogue as soon as you do this. Click the "Save" button at the bottom right of any of the tabs on the "Edit Path" screen 
...
"Highlight Text" box in the "Button Images" section. Enter the X and Y coordinates in the appropriate fields under
...
Height Values may range from 1 to 1080). Enter the X and Y coordinates in the appropriate fields under the 
...
### Deleting a Path
On the "Paths" list of "Project Home" screen, select the Path you would like to delete. Click the "Delete" button. The Path's name will be removed from the "Paths" list.<br>
...
"Delete" button. The Path Group's name will be removed from the "Paths Groups" list.<br>
_Warning:_ You cannot recover deleted Path Groups.

## Hubs
Hubs are a resting place before you direct the player to a number of possible destinations. Hubs consist of a 
...
"Delete" button. The Hub's name will be removed from the "Hub" list.<br>
...
the right or left arrow button on the right side of the "Ending Paths" to move the Path in the
